...
class BlogPostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        /** @var BlogPost $entity */
        $entity = $em->getRepository('AppBundle:BlogPost')->find(1);

        var_dump($entity->getCurrentLocale());exit();

        //$entity->setCurrentLocale('d');

        echo $entity->getTitle(). '--->' . $entity->getContent();exit('---->kazim');
    }
    /**
     ...
     * @Method("POST")
     * @Template("AppBundle:BlogPost:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:BlogPost')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:BlogPost:edit.html.twig")
     */
